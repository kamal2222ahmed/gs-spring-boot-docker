...
ref git repo: https://github.com/Transmode/gradle-docker
              https://github.com/sohrab-/microservice-simple-example
              https://spring.io/guides/gs/spring-boot-docker/#initial

to build image: gradle buildDocker
To run the container for the above image: docker run -e "SPRING_PROFILES_ACTIVE=dev" -p 8080:8080 -t springio/gs-spring-boot-docker
This docker microservice runs inside the secure network
